...
const connectionString = 'HostName=TarasFirstHub.azure-devices.net;DeviceId=AlwansDevice;SharedAccessKey=fLdRhf63hQUI0+trc4rzWXeI0XJPawvZ5BrTC9/czpI=';
const LEDPin = 4;
...
function getMessage(cb) {
  messageId++;
   cb(JSON.stringify({
        ...
        DeviceID: '11',
        CustomerNo: Math.ceil(messageId/2),
        Datetime:"Sat Aug 20 08:06:46 2022"//new Date()
      }),true)
